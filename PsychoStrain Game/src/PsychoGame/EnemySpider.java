...
public class EnemySpider extends Enemy {
    ...
    public EnemySpider(int Xposition, int Yposition, int damagePerHit, int hp, int timeInactive, int timeLoop){
        super("EnemySpider.txt", "enemy/Spider", Xposition, Yposition, damagePerHit, hp, timeInactive, timeLoop);
