...
public class EnemyChainRobot extends Enemy{
   ...
   public EnemyChainRobot(int Xposition, int Yposition, int damagePerHit, int hp, int timeInactive, int timeLoop){
        super("EnemyChainRobot.txt", "enemy/ChainRobot", Xposition, Yposition, damagePerHit, hp, timeInactive, timeLoop);
